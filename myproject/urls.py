...
from requests_app.views import RequestViewSet, RequestMessageViewSet 
from rest_framework_simplejwt.views import TokenObtainPairView, TokenRefreshView 
 
router = DefaultRouter() 
router.register(r'requests', RequestViewSet) 
router.register(r'requests/(?P<request_id>\d+)/messages', RequestMessageViewSet, basename='request-message') 
